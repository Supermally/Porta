...
public final class GraphicsBaselineValidator: ObservableObject, @unchecked Sendable {
    ...
    public func validateBaselineCapabilities() {
        ...
        let gptkPath = FileManager.default.homeDirectoryForCurrentUser.path + "/Library/Application Support/MacGaming/Runtimes/Wine/Contents/Resources/wine/lib/d3dmetal.dylib"
