...
public final class RuntimeManager: ObservableObject, @unchecked Sendable {
    ...
    public func detectRuntimes() {
        ...
        // 2. MacGaming / Local Runtime
        let localWine = fileManager.homeDirectoryForCurrentUser.path + "/Library/Application Support/MacGaming/Runtimes/Wine/Contents/Resources/wine/bin/wine"
        let localServer = fileManager.homeDirectoryForCurrentUser.path + "/Library/Application Support/MacGaming/Runtimes/Wine/Contents/Resources/wine/bin/wineserver"
