...
public final class EnvironmentManager: ObservableObject, @unchecked Sendable {
    ...
    public func loadEnvironments() {
        ...
        let appSupport = fileManager.homeDirectoryForCurrentUser.path + "/Library/Application Support/MacGaming"
    ...
    public func createEnvironment(name: String, description: String = "", isIsolated: Bool = true) -> EnvironmentItem {
        ...
        let prefixPath = FileManager.default.homeDirectoryForCurrentUser.path + "/Library/Application Support/MacGaming/prefixes/\(id)"
    ...
    public func getEnvironment(by id: String) -> EnvironmentItem {
        return environments.first(where: { $0.id == id }) ?? environments.first ?? EnvironmentItem(
            id: "default",
            name: "Default",
            prefixPath: FileManager.default.homeDirectoryForCurrentUser.path + "/Library/Application Support/MacGaming/prefixes/default"
        )
    }
}
