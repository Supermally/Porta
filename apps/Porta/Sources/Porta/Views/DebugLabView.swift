...
public struct DebugLabView: View {
    ...
    private func runSteamSetup() {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            let prefixURL = FileManager.default.homeDirectoryForCurrentUser
                .appendingPathComponent("Library/Application Support/Porta/prefixes/steam_test", isDirectory: true)
    ...
    private func openSteamPrefixFolder() {
        ...
        let prefixURL = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Application Support/Porta/prefixes", isDirectory: true)
